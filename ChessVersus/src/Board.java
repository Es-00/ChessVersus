public abstract class Board {
    ...
    protected abstract boolean updateBoard(int x, int y, int playerIndex);

    public abstract int xuZhao();

    // 0:正常 1：胜利 2：输入错误
    public int dropChessPiece(int x, int y, int playerIndex){
        ...
        countXuZhao = 0;
        if(this.updateBoard(x, y, playerIndex)) return 1;
        return 0;
    }
    ...
    public void setState(int[][] chessBoard, int countXuZhao){
...
class FirBoard extends Board{
    ...
    @Override
    protected boolean updateBoard(int x, int y, int playerIndex){
